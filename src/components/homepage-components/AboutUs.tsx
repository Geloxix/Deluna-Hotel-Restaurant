        ...
        <div className="h-screen pt-[100px] px-[15rem] font-poppins">
            <div className="flex gap-6 pt-[100px]">
                <div className='leading-8 basis-[70%]'>
                    ...
                    <p className='about-content transition-all ease-in duration-700ms'>Manager: <span className="text-color-1">Marc Angelo</span></p>
                </div>

                <div>
                    <div className="grid grid-cols-2 gap-3 about-content transition-all ease-in duration-600ms">
